$(document).ready(function(){
    ...
    //***********************
    //**评论的代码也删掉哦***
    window.disqus_shortname = 'yu'; // required: replace example with your forum shortname
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('wuyu201321060203.github.com')>-1 ){
